    ...
    <section className="bg-black text-white pt-36">
      <div className="container text-center w-3/4 md:w-4/6">
        ...
        <div className="mb-20">
          ...
          <button className="bg-bgSecondary hover:bg-white focus:bg-white hover:text-bgSecondary focus:text-bgSecondary border-2 border-bgSecondary py-2 px-6 text-base lg:text-lg rounded-lg font-poppins w-1/2 md:w-1/4">
            Try it now
          </button>
        </div>
        {/* hero secton  */}
